...
import {
    ...
    JsonRpcPayload,
    JsonRpcResponse
} from 'test3js-core-helpers';
import { Method } from 'test3js-core-method';
...
// had to move `test3js-net` due to other modules in `1.x` not referencing
...
// had to move accounts from test3js-eth-accounts due to other modules in 1.x not referencing
...
// put all the `test3js-provider` typings in here so we can get to them everywhere as this module does not exist in 1.x
