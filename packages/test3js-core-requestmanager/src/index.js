...
var errors = require('../../test3js-providers-http/types/node_modules/test3js-core-helpers').errors;
...
RequestManager.providers = {
    WebsocketProvider: require('test3js-providers-ws'),
    HttpProvider: require('../../test3js-providers-http/types'),
    IpcProvider: require('test3js-providers-ipc')
};
