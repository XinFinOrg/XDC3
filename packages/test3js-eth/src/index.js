...
var core = require('test3js-core');
var helpers = require('test3js-core-helpers');
var Subscriptions = require('test3js-core-subscriptions').subscriptions;
var Method = require('test3js-core-method');
var utils = require('test3js-utils');
var Net = require('test3js-net');

var ENS = require('test3js-eth-ens');
var Personal = require('test3js-eth-personal');
var BaseContract = require('test3js-eth-contract');
var Iban = require('test3js-eth-iban');
var Accounts = require('test3js-eth-accounts');
var abi = require('test3js-eth-abi');
...
var Eth = function Eth() {
    ...
    // test3js-eth would subsequently change the provider for _all_ contract
    // instances!
    var self = this;
    ...
    // make our proxy Contract inherit from test3js-eth-contract so that it has all
        ...
        new Subscriptions({
            ...
            subscriptions: {
                ...
                'logs': {
                    ...
                    inputFormatter: [formatter.inputLogFormatter],
                    outputFormatter: formatter.outputLogFormatter,
                    // DUBLICATE, also in test3js-eth-contract
